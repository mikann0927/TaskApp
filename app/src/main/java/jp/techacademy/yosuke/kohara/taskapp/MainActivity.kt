package jp.techacademy.yosuke.kohara.taskapp
...
const val EXTRA_TASK = "jp.techacademy.yosuke.kohara.taskapp.TASK"
...
class MainActivity : AppCompatActivity() {
    ...
    private fun reloadListView() {
        ...
        button1.setOnClickListener {
            ...
            if (search != "") {
                // Realmデータベースから、「データを取得して新しい日時順に並べた結果」を取得
                val taskRealmQuery = mRealm.where(Task::class.java)
